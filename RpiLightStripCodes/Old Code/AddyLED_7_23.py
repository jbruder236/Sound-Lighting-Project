...
# 7/23 Patch Notes:
# -Average/Max Peak Tracking for peak adjustment
# -Increased Sampling Rate to 88200 Hz
# -Introduced var for speed modulation of rainbow color change cycle
...
def soundLight(strip, wait_ms=20):
    ...
    for i in range(256*20):
        ...
        bars = "#"*int(peak/10)
        #print("i:%04d  peak:%03d   Delta:%02d   maxPeak:%03d  %s"% (i, peak, peakDelta, maxPeak, bars))
